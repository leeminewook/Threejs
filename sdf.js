...
function init() {
  ...
  for (var i = 0; i < 100; i++) {
    ...
    sphereTab.push(
      new THREE.Mesh(
        new THREE.SphereGeometry(Math.random() * 30 + 10, 20, 20),
        lumiereS
      )
    );
  }
  ...
  document
    .getElementById("div2")
    .addEventListener("click", changeTexture2, false);
  document
    .getElementById("div3")
    .addEventListener("click", changeTexture3, false);
  document
    .getElementById("div4")
    .addEventListener("click", changeTexture4, false);
